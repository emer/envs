...
var AllConditions = map[string]Condition{
	...
	"PosAcq_contextA": {
		Name:          "PosAcq_contextA",
		Desc:          "Pavlovian conditioning w/ positively-valenced US: A_Rf_POS, A_Rf_POS_omit trials, interleaved",
		Block:         "PosAcq_contextA",
		FixedProb:     false,
		NIters:        26,
		BlocksPerIter: 10,
		Permute:       false,
	...
	"PosExtinct_contextB": {
		Name:          "PosExtinct_contextB",
		Desc:          "Pavlovian conditioning w/ positively-valenced US: A_Rf_POS, A_Rf_POS_omit trials, interleaved",
		Block:         "PosExtinct_contextB",
		FixedProb:     false,
		NIters:        25,
		BlocksPerIter: 10,
		Permute:       false,
	...
	"PosRenewal_contextA": {
		Name:          "PosRenewal_contextA",
		Desc:          "Pavlovian conditioning w/ positively-valenced US: A_Rf_POS, A_Rf_POS_omit trials, interleaved",
		Block:         "PosRenewal_contextA",
		FixedProb:     false,
		NIters:        1,
		BlocksPerIter: 2,
		Permute:       false,
	...
	"PosBlocking_A_training": {
		Name:          "PosBlocking_A_training",
		Desc:          "Blocking experiment",
		Block:         "PosBlocking_A_training",
		FixedProb:     false,
		NIters:        50,
		BlocksPerIter: 1,
		Permute:       false,
	...
	"NegBlocking_E_training": {
		Name:          "NegBlocking_E_training",
		Desc:          "Blocking experiment",
		Block:         "NegBlocking_E_training",
		FixedProb:     false,
		NIters:        300,
		BlocksPerIter: 1,
		Permute:       false,
