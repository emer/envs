...
func (ev *XYHDEnv) Config(ntrls int) {
	...
	//ev.Acts = []string{"Stay", "N", "E", "S", "W", "NE", "SE", "SW", "NW"}
...
func (ev *XYHDEnv) IncState(nm string, inc float32) {
